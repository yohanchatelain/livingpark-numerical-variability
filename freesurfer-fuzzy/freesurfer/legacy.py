...
class TableWriter:
    ...
    def assign_attributes(self, filename="stats.table", row1col1="", delimiter="\t"):
            ...
            if not statstable.cross:
                ...
                for i, tpdata, addtpdata in itertools.izip(
                    ...
                    self.subjects_tp_map[subjectid][i] = list(
                        itertools.chain(
                            *[self.subjects_tp_map[subjectid][i], addtplist[i][1:]]
                        )
                    )
            else:
                ...
                for i, tpdata in itertools.izip(itertools.count(), tplist):
                    ...
                    self.subjects_tp_map[subjectid][i] = list(
                        itertools.chain(
                            *[self.subjects_tp_map[subjectid][i], addtplist[0][1:]]
                        )
                    )
